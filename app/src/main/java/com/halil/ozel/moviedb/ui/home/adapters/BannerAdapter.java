...
public class BannerAdapter extends RecyclerView.Adapter<BannerAdapter.PopularMovieHolder> {
    ...
    public BannerAdapter(List<Results> popularMovieList, Context context) {
    ...
    @NonNull
    @Override
    public BannerAdapter.PopularMovieHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        App.instance().appComponent().inject(this);
        return new BannerAdapter.PopularMovieHolder(LayoutInflater.from(context).inflate(R.layout.row_banner_item, parent, false));
    }


    @Override
    public void onBindViewHolder(@NonNull final BannerAdapter.PopularMovieHolder holder, final int position) {
